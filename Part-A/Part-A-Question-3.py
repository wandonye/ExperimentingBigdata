...
if __name__ == "__main__":
    ...
    # app name
    appName = "CS-838-Assignment2-PartA-Question3" #+ '-' + str(N_PARTITIONS)
    ...
    links = lines.map(lambda urls: parseNeighbors(urls)).groupByKey(numPartitions = N_PARTITIONS).cache()
